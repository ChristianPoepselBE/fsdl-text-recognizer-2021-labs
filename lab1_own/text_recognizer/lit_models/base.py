...
class BaseLitModel(pl.LightningModule): # pyling: disable= too-many-ancestors
    """
    Generic Pytoch-Lightning class that mus tbe initialized with a Pytorch module.
    """        
    ...
    def add_to_argparse(parser):
        parser.add_argument("--optimizer", type=str, default=OPTIMIZER, help="optimizer classfrom torch.optim")
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.OneCycleLR(
            optimizer=optimizer, max_lr=self.once_cycle_max_lr, total_steps=self.once_cycle_total_steps
        )
