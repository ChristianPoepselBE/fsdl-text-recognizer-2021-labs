...
def _setup_parser():
    """ Set up Python's ArgumentParsser weith data, model, trainer, and other arguments."""
    ...
    #Get data, model and LitModel specific argmuments
...
def main():
    ...
    trainer.tune(lit_model, datamodule=data) # if passing --auto_lr_find, this will set learningrate

    trainer.fit(lit_model, datamodule=data)
    trainer.test(lit_model, datamodule=data)
    # pyling: enable=no-member
